...
| Зависимоть между решения от других систем	| Взаимодействие с БД |
| Прототип интерфейса	| - |
